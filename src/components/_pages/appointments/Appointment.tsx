...
function Appointment({ title, time }: AppointmentProps) {
  return (
    <section className="container w-full rounded-lg bg-white p-3 mb-3 hover:shadow-md transition  ">
      ...
      <div className="w-full">
        <p className="text-sm text-gray-600 ml-3">{time}</p>
